...
![w:12cm](v2-6ec92493255b176f5e521672bdc2029b_r.jpg)
...
![w:12cm](Brane-wlwswv-zh-hant.jpg)
...
在惯性系中，两事件之间的间隔$\Delta s^2$定义为$\Delta s^2=-\Delta t^2+\Delta x^2$，这是二维时空中的间隔，调节$\Delta x^2$项，不难推广到更高维的时空中。
...
![bg right:40% w:13cm](v2-3670907a3f16a797e8c948c71892615d_720w.jpg)

---

## Proper Time

固有时，顾名思义就是一个质点固有的事件，类似时空间隔的定义，一个质点的固有时就是质点自身所经历的时间。一个质点的世界线上的任意两个事件$p_1$和$p_2$之间的固有时定义为：
$$
\tau=\int_{p_1}^{p_2}\sqrt{-ds^2}
$$

![bg right:40% w:8cm](v2-e6565a67b71e8b0591033705382e08c6_720w.jpg)
![bg right:50% w:8cm](v2-efb0c7a456280cf3534a16f1c298b41f_720w.jpg)
...
首先我们定义地面系$(x,t)$和飞船系$(x',t')$，把两个坐标系华仔同一张时空图上。对于任意一个事件A，我们可以在时空图中进行投影：

![bg right:40% w:15cm](v2-1c43b16a9ba52ebb297aa1799b1b8f81_720w.jpg)

从图中可以看到，事件A在飞船系中发生事件早于飞船的当前时间，这直观反映了两个参考系的同时性的丧失。

那么，问题的答案是什么呢？这需要我们对飞船掉头的时刻所发生的事情进行分析。
...
![bg right:40% w:14cm](v2-27b80b7a84d91ea2c9d9d76287349c0a_720w.jpg)
...
![bg right:40% w:14cm](v2-97e9c26a010a83a84e39c34f0434b849_720w.jpg)
